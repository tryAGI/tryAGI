...
**Audio / Speech:**
`AssemblyAI/`, `AsyncAI/`, `Audra/`, `BytePlusSeedSpeech/`, `Cartesia/`, `Deepgram/`, `ElevenLabs/`, `FishAudio/`, `Gladia/`, `Gradium/`, `Inworld/`, `LalalAI/`, `LMNT/`, `LocalSpeechToText/`, `MiniMax/`, `Murf/`, `NariLabs/`, `PlayHT/`, `ResembleAI/`, `RetellAI/`, `RevAI/`, `Revocalize/`, `Reverie/`, `Rime/`, `SmallestAI/`, `Speechify/`, `Speechmatics/`, `StepFun/`, `Ultravox/`, `Vapi/`, `VoiceAI/`, `ZAI/`
